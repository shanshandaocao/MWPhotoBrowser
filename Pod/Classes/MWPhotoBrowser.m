...
- (void)viewDidLoad {
    ...
    if (self.displayActionButton) {
        UIImage *actionButtonImage = [UIImage imageNamed:@"photo_share"];
        _actionButton = [[UIBarButtonItem alloc] initWithImage:actionButtonImage style:UIBarButtonItemStylePlain target:self action:@selector(actionButtonPressed:)];
    }
